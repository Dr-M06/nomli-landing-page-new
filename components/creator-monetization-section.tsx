...
export function CreatorMonetizationSection() {
  ...
  return (
    <section id="creator-monetization" ref={ref} className="relative py-12 sm:py-24 bg-[#fbfbfd] overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 items-center">
          ...
          >
            <div className="relative rounded-[1.35rem] sm:rounded-[1.75rem] border border-[#e5e7f5] bg-white p-3 sm:p-4 shadow-[0_16px_34px_rgba(15,23,42,0.08)] sm:shadow-[0_20px_50px_rgba(15,23,42,0.08)] max-w-[430px] sm:max-w-[520px] lg:ml-auto">
              <div className="rounded-[1.2rem] bg-gradient-to-br from-[#181735] to-[#20395c] p-2.5 sm:p-3">
                <div className="w-full aspect-[4/5] sm:aspect-[16/17] rounded-[0.9rem] overflow-hidden">
                  <img
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                <div>
                  <p className="text-xs sm:text-sm font-semibold text-[#27253a]">In-app creator campaign</p>
