...
const logoPath = path.join(publicDir, 'images/nomli-logo.jpeg');
...
async function generateFavicons() {
  try {
    ...
    if (!fs.existsSync(logoPath)) {
      ...
      console.log('Please ensure nomli-logo.png exists in the public folder');
      return;
    }

    console.log('🎨 Generating favicons from nomli-logo.jpeg...\n');
