...
if (!newAppId) {
  console.log('Usage: node scripts/update-agora-app-id.js YOUR_NEW_APP_ID');
  console.log('Example: node scripts/update-agora-app-id.js 1234567890abcdef1234567890abcdef');
  process.exit(1);
}
